...
public class Game {
	...
	private String board; //not sure whether this should go here. It should be specific to a client pair.
	
	/** All previous boards, to check whether a move is valid */
	private String[] prevBoards; //not sure whether this should go here. It should be specific to a client pair.
