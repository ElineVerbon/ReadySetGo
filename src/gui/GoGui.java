...
public interface GoGui {
     ...
     * Does noting if the position currently has no stone/area indicator.
     * @param x; x coordinate of the stone/area indicator to remove, ranges from 0 to boardSize - 1.
     * @param y; y coordinate of the stone/area indicator to remove, ranges from 0 to boardSize - 1.
     * @throws InvalidCoordinateException when x or y coordinate fall outside of the board.
     */
